...
```sh
brew tap vdanen/pymnifocus
brew install pymnifocus
```

Refer to the manpages or the
[pymnifocus](https://github.com/vdanen/pymnifocus) git repo for more
information on uage.
